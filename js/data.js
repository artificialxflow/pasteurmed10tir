  ...
  memberships: [
    {
      ...
      priceNum: 1200000,
      features: [
        'وام درمانی ۱۲٪ تا سقف ۲۵۰ میلیون تومان برای طرح ۲ ساله',
        'وام درمانی ۱۲٪ تا سقف ۱۲۵ میلیون تومان برای طرح ۱ ساله',
      ...
      terms: 'مناسب مشتریان عادی — بدون خدمات زیبایی خط‌خورده و بدون مزایای VIP تجهیزات',
      highlighted: false,
    },
    {
      id: 'vip',
      ...
      priceNum: 1800000,
      features: [
        'وام درمانی ۱۲٪ تا سقف ۵۰۰ میلیون تومان برای طرح ۲ ساله',
        'وام درمانی ۱۲٪ تا سقف ۲۵۰ میلیون تومان برای طرح ۱ ساله',
        ...
        '۲٪ تخفیف محصولات تجهیزات و امکان درخواست تسهیلات',
      ],
      terms: 'پرداخت هزینه VIP برای فعال‌سازی مزایای دندانپزشکی و تجهیزات — مطابق شرایط تایید شده',
      highlighted: true,
    },
  ],
