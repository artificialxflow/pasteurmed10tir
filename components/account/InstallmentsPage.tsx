    ...
    <div className={variant === "app" ? "space-y-4" : "mx-auto max-w-2xl space-y-4 px-4 py-10"}>
      ...
      {!plans.length ? (
        <p className="text-center text-sm text-slate-500">
          هنوز طرح اقساطی فعالی ندارید. اقساط اعتباری پس از درخواست فعال‌سازی کارت و تأیید ادمین،
          وام درمانی پس از تأیید در ادمین عضویت‌ها، و تسهیلات تجهیزات پس از تأیید در ادمین تسهیلات
          اینجا دیده می‌شود.
        </p>
      ) : null}
    </div>
