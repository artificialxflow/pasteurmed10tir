      ...
      {wallet && settings ? (
        <div className="space-y-6">
          ...
          <Card hover={false} className="border-slate-200 bg-slate-50 p-4 text-sm leading-7 text-slate-700">
            <p>
              <strong>سقف اعتبار</strong> با عضویت/VIP تعیین می‌شود و با تأیید فعال‌سازی عوض
              نمی‌شود. وقتی درخواست فعال‌سازی (مثلاً ۲۰ میلیون) تأیید شود، همان مبلغ به{" "}
              <strong>موجودی مصرف‌شده</strong> اضافه می‌شود تا <strong>اعتبار باقی‌مانده</strong>{" "}
              کم شود و طرح اقساط متناظر ساخته شود.
            </p>
          </Card>
