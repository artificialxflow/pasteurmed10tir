...
export const PASTEUR_DATA = {
  ...
  dentists: [
    ...
    },
    {
      ...
      specialty: 'ایمپلنت',
      specialtyId: 'implant',
      image: 'https://images.unsplash.com/photo-1582750433449-648ed127fbfe?w=200&h=200&fit=crop',
      days: ['شنبه', 'سه‌شنبه'],
      hours: '۹ تا ۱۵',
      status: 'available',
      schedule: {
        شنبه: { visitHours: buildVisitHours(9, 15), treatmentSlots: buildTreatmentSlots(9, 15, [10, 13]) },
        'سه‌شنبه': { visitHours: buildVisitHours(9, 15), treatmentSlots: buildTreatmentSlots(9, 15, [11]) },
      },
    },
    {
      id: 6,
      ...
      status: 'available',
      schedule: {
        یکشنبه: { visitHours: buildVisitHours(10, 18), treatmentSlots: buildTreatmentSlots(10, 18, [12, 16]) },
        پنجشنبه: { visitHours: buildVisitHours(10, 18), treatmentSlots: buildTreatmentSlots(10, 18, [14]) },
      },
    },
    {
      id: 7,
      ...
      image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop',
      days: ['دوشنبه', 'چهارشنبه', 'شنبه'],
      hours: '۸ تا ۱۴',
      status: 'available',
      schedule: {
        دوشنبه: { visitHours: buildVisitHours(8, 14), treatmentSlots: buildTreatmentSlots(8, 14, [9]) },
        چهارشنبه: { visitHours: buildVisitHours(8, 14), treatmentSlots: buildTreatmentSlots(8, 14, [10, 12]) },
        شنبه: { visitHours: buildVisitHours(8, 14), treatmentSlots: buildTreatmentSlots(8, 14, [11]) },
      },
    },
  ],
